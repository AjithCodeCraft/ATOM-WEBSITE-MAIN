            ...
            <section className="mb-4">
                ...
                <div className="flex justify-center w-full">
                    <div className='lg:w-5/12 w-full flex flex-col'>
                        <form onSubmit={handleSubmit} className="mb-12 w-full md:px-3 flex flex-col justify-center lg:mb-20 lg:px-6">
                            ...
                            <div className="mb-3 w-full">
                                <label className="block font-medium mb-[2px] text-indigo-600" htmlFor="phonenumberInput">
                                    Phone number
                                </label>
                                <input
                                    type="tel"
                            ...
                            <button
                                type='submit'
                                className="mb-6 inline-block w-full rounded-full bg-indigo-600 px-6 py-2.5 font-medium uppercase leading-normal text-white hover:shadow-md hover:bg-indigo-800 transition-all"
                            >
                                Send
                            </button>
                        </form>
                                    ...
                                    <div className="flex items-start">
                                        <div className="inline-block rounded-md  p-4 text-indigo-600">
                                            <Link href='https://www.instagram.com/atomiasofficial?igsh=Z2hsczJwempxcWto' target="_blank">
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" className='w-10 h-10 stext-indigo-600 hover:scale-150 transition-all'>
